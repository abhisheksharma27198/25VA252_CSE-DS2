...
function App() {
  // 1. STATE VARIABLES (जो डेटा स्क्रीन पर बदलेगा)
  ...
  // 2. HARDCODED PRODUCTS DATA (ताकि दूसरी फाइल ना बनानी पड़े - Exp 7 Concept)
  const products = [
    ...
    // Naye items yahan add kiye hain 👇
  ...
  // 3. FUNCTIONS (जो काम करेंगे)
  // Add to cart dabane par counter ko +1 badhao
  const addToCart = () => {
    setCartCount(cartCount + 1);
  };

  // Search box ke hisab se products ko filter karo
